...
prism_config =
  Testcontainers.Container.new("stoplight/prism:5")
  ...
  |> Testcontainers.Container.with_waiting_strategy(
    Testcontainers.LogWaitStrategy.new(~r/Prism is listening/, 60_000)
  )
...
wiremock_config =
  ...
  |> Testcontainers.Container.with_waiting_strategy(
    Testcontainers.LogWaitStrategy.new(~r/port:/, 60_000)
  )
