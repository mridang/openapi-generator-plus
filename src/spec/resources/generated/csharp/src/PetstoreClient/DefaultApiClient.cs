...
public sealed class DefaultApiClient : IApiClient, IDisposable
{
    ...
    )
    {
        ...
        {
            // byte[] and string both implement IList/IEnumerable but must be
            // treated as single multipart parts, not iterated element-by-element.
