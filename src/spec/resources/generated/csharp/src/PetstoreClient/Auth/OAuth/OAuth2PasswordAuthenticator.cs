...
public class OAuth2PasswordAuthenticator : BaseAuthenticator, IHttpAwareAuthenticator
{
    ...
    /// <summary>
    /// Returns a string representation with the client secret and the resource
    /// owner password redacted so neither credential leaks into logs, stack
    /// traces, or debugger output.
    /// </summary>
    public override string ToString()
    {
        return $"{GetType().Name}(Host={_host}, ClientId={_clientId}, ClientSecret=***, Username={_username}, Password=***)";
    }
}
