        ...
        IHttpAwareAuthenticator
{
    ...
    {
        /* Reject an empty/whitespace authorization code before issuing the
         * token POST: an empty code is a programmer/precondition error that
         * would otherwise surface as a confusing downstream OAuth error.
         * Matches the harmonised cross-SDK canonical (validate code non-empty
         * before the exchange). */
