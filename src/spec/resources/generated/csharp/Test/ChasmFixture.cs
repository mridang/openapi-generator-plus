...
public class ChasmFixture : IAsyncLifetime
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        _chasm = new ContainerBuilder("mridang/chasm:1.3.0")
        ...
        _squid = new ContainerBuilder("ubuntu/squid:5.2-22.04_beta")
            ...
            // mode=1777 because squid runs as the unprivileged `proxy` user, and
            // WithTmpfsMount cannot pass mount options.
