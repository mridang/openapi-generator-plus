...
public class OAuth2PasswordAuthenticatorTest
{
    ...
    /// <summary>
    /// ToString() must redact both secrets (the client secret and the resource
    /// owner password): neither raw value may leak and the masked placeholder
    /// must be present.
    /// </summary>
    [Fact]
    public void RedactsSecret()
    {
        ...
        Assert.DoesNotContain("testpass", repr);
