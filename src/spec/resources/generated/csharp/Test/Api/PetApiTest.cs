...
public class PetApiTest
{
    ...
    {
        var result = await _api.GetPetByNameAsync(
            "Rex",
            new GetPetByNameOptions { Category = "dogs" }
        );
    ...
    public async Task TestDeletePetRejectsControlCharInCookieParam()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            _api.DeletePetAsync(1L, new DeletePetOptions { Auth = _auth, ApiKey = "abc\x07def" })
        );
    }
    ...
    public async Task TestConfiguredAuthenticatorIsAppliedToSecuredOperation()
    {
        ...
        var pet = new Pet("AppliedDog", new HashSet<string> { "http://example.com/p.jpg" })
        {
            Id = 1L,
        };
    ...
    public async Task TestOptionalArrayQueryParamsSerializeStyledNotDebugBlob()
    {
        ...
        await api.GetPetTagAsync(
            7L,
            "tag",
            new GetPetTagOptions { Colors = ["blue", "black"], Sizes = ["S", "M"] }
        );
    ...
    public async Task UploadPetDocumentOctetStreamSendsRawBytes()
    {
        ...
        await multipartApi.UploadPetDocumentWithHttpInfoAsync(
            ...
            new UploadPetDocumentOptions
            {
                File = new MemoryStream(rawBytes),
