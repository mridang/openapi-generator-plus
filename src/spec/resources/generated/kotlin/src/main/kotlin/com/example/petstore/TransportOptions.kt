...
class TransportOptions private constructor(
    ...
    class Builder {
        ...
        fun proxy(proxy: String?): Builder = apply {
            if (proxy != null) {
                try {
        ...
        fun defaultHeader(name: String, value: String): Builder = apply { defaultHeaders[name] = value }
        ...
        fun build(): TransportOptions = TransportOptions(
            verifySsl, caCertPath, proxy, timeout, followRedirects,
            maxRedirects, userAgent, defaultHeaders.toMap(), injectRequestId
        )
    }
}
