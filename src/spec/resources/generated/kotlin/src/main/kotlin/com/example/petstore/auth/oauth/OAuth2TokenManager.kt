...
class OAuth2TokenManager {
    ...
    suspend fun getAccessToken(
        ...
        return refreshMutex.withLock {
            ...
            accessToken ?: throw OAuth2TokenException("Token fetch did not return an access token")
        }
    }
    ...
    private suspend fun fetchToken(
        ...
        val jsonObject =
             ...
             * IllegalArgumentException, as does .jsonObject on a non-object. */
                throw OAuth2TokenException("Token response is not a JSON object: ${e.message}", e)
            }
        val accessTokenValue = jsonObject["access_token"]?.jsonPrimitive?.contentOrNull
        if (accessTokenValue.isNullOrEmpty()) {
            throw OAuth2TokenException("Token response missing or empty access_token field")
        }
    ...
    private fun parseOAuth2ServerError(
        ...
        try {
            ...
            if (!code.isNullOrEmpty()) {
                ...
                return OAuth2ServerException(statusCode, code, description, uri, body)
            }
        } catch (_: Exception) {
