...
class DefaultApiClient : ApiClient {
        ...
        withContext(Dispatchers.IO) {
            ...
            val requestBody: RequestBody? =
                when {
                    ...
                    body is InputStream ->
                        body.use { it.readBytes() }.toRequestBody("application/octet-stream".toMediaType())
                    else -> {
    ...
    private fun decompressBrotli(data: ByteArray): ByteArray =
        try {
            ...
            throw java.io.IOException("Failed to decompress brotli response", e)
        }
    ...
    private fun decompressZstd(data: ByteArray): ByteArray =
        try {
            ...
            throw java.io.IOException("Failed to decompress zstd response", e)
        }
