...
#[test]
fn test_store_api_delete_order_not_found() {
    let api = new_store_api_for_mock(404, "application/json", r#"{"message":"Order not found"}"#);

    let result = api.delete_order(99999);
    assert!(
        result.is_err(),
