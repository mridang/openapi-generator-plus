...
struct TestContainers {
    wiremock_http_url: String,
    wiremock_https_url: String,
...
fn init_containers_inner() -> TestContainers {
    ...
    // Start Prism
    let prism = GenericImage::new("mridang/chasm", "1")
...
pub fn wiremock_http_url() -> &'static str {
    &init_containers().wiremock_http_url
}

pub fn wiremock_https_url() -> &'static str {
    &init_containers().wiremock_https_url
}

pub fn wiremock_internal_http_url() -> &'static str {
    &init_containers().wiremock_internal_http_url
}

pub fn wiremock_internal_https_url() -> &'static str {
    &init_containers().wiremock_internal_https_url
}
