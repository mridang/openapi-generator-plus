...
impl PetApi {
    ...
    pub fn add_pet(
        ...
        let result = self.add_pet_with_http_info(auth, pet)?;
        Ok(result.data)
    }

    /// Performs the add_pet operation and returns the full API result.
    pub fn add_pet_with_http_info(
        &self,
        auth: &dyn Authenticator,
        pet: Pet,
    ...
    pub fn delete_pet(
        ...
        let result = self.delete_pet_with_http_info(auth, pet_id)?;
        let _ = result;
        Ok(())
    }

    /// Performs the delete_pet operation and returns the full API result.
    pub fn delete_pet_with_http_info(
        &self,
        auth: &dyn Authenticator,
        pet_id: i64,
    ...
    pub fn download_pet_document(
        &self,
        pet_id: i64,
        document_id: i64,
    ) -> Result<Vec<u8>, Box<dyn std::error::Error + Send + Sync>> {
        let result = self.download_pet_document_with_http_info(pet_id, document_id)?;
        Ok(result.data)
    }

    /// Performs the download_pet_document operation and returns the full API result.
    pub fn download_pet_document_with_http_info(
        &self,
        pet_id: i64,
        document_id: i64,
    ...
    pub fn find_pets_by_status(
        ...
        let result = self.find_pets_by_status_with_http_info(options)?;
        Ok(result.data)
    }

    /// Performs the find_pets_by_status operation and returns the full API result.
    pub fn find_pets_by_status_with_http_info(
        &self,
    ...
    pub fn get_external_pet_info(
        &self,
        pet_id: i64,
    ) -> Result<Pet, Box<dyn std::error::Error + Send + Sync>> {
        let result = self.get_external_pet_info_with_http_info(pet_id)?;
        Ok(result.data)
    }

    /// Performs the get_external_pet_info operation and returns the full API result.
    pub fn get_external_pet_info_with_http_info(
        &self,
        pet_id: i64,
    ) -> Result<ApiResult<Pet>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub fn get_multi_server_pet_info(
        &self,
        pet_id: i64,
    ) -> Result<Pet, Box<dyn std::error::Error + Send + Sync>> {
        let result = self.get_multi_server_pet_info_with_http_info(pet_id)?;
        Ok(result.data)
    }

    /// Performs the get_multi_server_pet_info operation and returns the full API result.
    pub fn get_multi_server_pet_info_with_http_info(
        &self,
        pet_id: i64,
    ) -> Result<ApiResult<Pet>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub fn get_pet_avatar(
        &self,
        pet_id: i64,
    ) -> Result<Vec<u8>, Box<dyn std::error::Error + Send + Sync>> {
        let result = self.get_pet_avatar_with_http_info(pet_id)?;
        Ok(result.data)
    }

    /// Performs the get_pet_avatar operation and returns the full API result.
    pub fn get_pet_avatar_with_http_info(
        &self,
        pet_id: i64,
    ) -> Result<ApiResult<Vec<u8>>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub fn get_pet_avatar_thumbnail(
        &self,
        pet_id: i64,
    ) -> Result<Vec<u8>, Box<dyn std::error::Error + Send + Sync>> {
        let result = self.get_pet_avatar_thumbnail_with_http_info(pet_id)?;
        Ok(result.data)
    }

    /// Performs the get_pet_avatar_thumbnail operation and returns the full API result.
    pub fn get_pet_avatar_thumbnail_with_http_info(
        &self,
        pet_id: i64,
    ) -> Result<ApiResult<Vec<u8>>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub fn get_pet_by_id(
        ...
        let result = self.get_pet_by_id_with_http_info(pet_id)?;
        Ok(result.data)
    }

    /// Performs the get_pet_by_id operation and returns the full API result.
    pub fn get_pet_by_id_with_http_info(
        &self,
        pet_id: i64,
    ) -> Result<ApiResult<Pet>, Box<dyn std::error::Error + Send + Sync>> {
        let mut path = "/pet/{petId}".to_string();
    ...
    pub fn get_pet_photo(
        &self,
        pet_id: i64,
        photo_id: i64,
    ) -> Result<Vec<u8>, Box<dyn std::error::Error + Send + Sync>> {
        let result = self.get_pet_photo_with_http_info(pet_id, photo_id)?;
        Ok(result.data)
    }

    /// Performs the get_pet_photo operation and returns the full API result.
    pub fn get_pet_photo_with_http_info(
        &self,
        pet_id: i64,
        photo_id: i64,
    ) -> Result<ApiResult<Vec<u8>>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub fn get_pet_tag(
        ...
        let result = self.get_pet_tag_with_http_info(pet_id, tag_name, options)?;
        Ok(result.data)
    }

    /// Performs the get_pet_tag operation and returns the full API result.
    pub fn get_pet_tag_with_http_info(
        &self,
        pet_id: i64,
        tag_name: String,
    ...
    pub fn get_staging_pet_info(
        &self,
        pet_id: i64,
    ) -> Result<Pet, Box<dyn std::error::Error + Send + Sync>> {
        let result = self.get_staging_pet_info_with_http_info(pet_id)?;
        Ok(result.data)
    }

    /// Performs the get_staging_pet_info operation and returns the full API result.
    pub fn get_staging_pet_info_with_http_info(
        &self,
        pet_id: i64,
    ) -> Result<ApiResult<Pet>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub fn set_pet_avatar(
        &self,
        pet_id: i64,
        body: Vec<u8>,
    ) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        let result = self.set_pet_avatar_with_http_info(pet_id, body)?;
        let _ = result;
        Ok(())
    }

    /// Performs the set_pet_avatar operation and returns the full API result.
    pub fn set_pet_avatar_with_http_info(
        &self,
        pet_id: i64,
        body: Vec<u8>,
    ) -> Result<ApiResult<()>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub fn set_pet_avatar_thumbnail(
        &self,
        pet_id: i64,
        set_pet_avatar_thumbnail_request: SetPetAvatarThumbnailRequest,
    ) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
        let result =
            self.set_pet_avatar_thumbnail_with_http_info(pet_id, set_pet_avatar_thumbnail_request)?;
        let _ = result;
        Ok(())
    }

    /// Performs the set_pet_avatar_thumbnail operation and returns the full API result.
    pub fn set_pet_avatar_thumbnail_with_http_info(
        &self,
        pet_id: i64,
        set_pet_avatar_thumbnail_request: SetPetAvatarThumbnailRequest,
    ) -> Result<ApiResult<()>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub fn update_pet(
        ...
        let result = self.update_pet_with_http_info(pet_id, pet)?;
        Ok(result.data)
    }

    /// Performs the update_pet operation and returns the full API result.
    pub fn update_pet_with_http_info(
        &self,
        pet_id: i64,
        pet: Pet,
    ) -> Result<ApiResult<Pet>, Box<dyn std::error::Error + Send + Sync>> {
    ...
    pub fn upload_pet_document(
        &self,
        pet_id: i64,

        options: Option<&UploadPetDocumentOptions>,
    ) -> Result<ApiResponse, Box<dyn std::error::Error + Send + Sync>> {
        let result = self.upload_pet_document_with_http_info(pet_id, options)?;
        Ok(result.data)
    }

    /// Performs the upload_pet_document operation and returns the full API result.
    pub fn upload_pet_document_with_http_info(
        &self,
        pet_id: i64,
