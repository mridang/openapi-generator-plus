...
impl OAuth2TokenManager {
    ...
    pub fn set_api_client(&self, client: Box<dyn ApiClient>) {
    ...
    pub fn get_access_token(
        ...
        Self::fetch_token(&mut inner, token_url, params)?;
    ...
    fn fetch_token(
        ...
        let client = inner.api_client.as_ref().ok_or_else(|| {
        ...
        let response = client.send_request("POST", token_url, &headers, body.as_bytes())?;
