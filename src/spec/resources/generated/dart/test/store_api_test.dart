...
void main() {
  ...
  group('StoreApi', () {
    ...
    test(
      'getGroupedCategories decodes nested container leaves into Category',
      () async {
        final server = await HttpServer.bind(InternetAddress.loopbackIPv4, 0);
        server.listen((request) {
          request.response
