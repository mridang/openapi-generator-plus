    ...
    test(
      ...
      () async {
        ...
        final futures = List.generate(
          10,
          (_) => manager.getAccessToken('https://auth.example.com/token', {
            'grant_type': 'client_credentials',
          }),
        );
          ...
          throwsA(
            isA<OAuth2ServerError>()
                ...
                .having(
                  (e) => e.uri,
                  'uri',
                  'https://docs.example.com/errors/invalid_grant',
                ),
          ),
        );
      },
