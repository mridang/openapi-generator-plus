  ...
  group('BaseApi', () {
    ...
    test('serializes JSON body for POST', () async {
      ...
      try {
        ...
        await api.addPet(Pet(name: 'TestPet', photoUrls: <String>{}), auth: auth);
