  ...
  group('PetApi', () {
    ...
    test('getPetAvatar', () async {
      ...
      expect(result, isNotNull);
        ...
        skip:
            'chasm returns JSON-encoded "binary" placeholder for binary response types; Dart SDK cast to List<int> needs lenient string handling');
    ...
    test('getPetAvatarThumbnail', () async {
      ...
      expect(result, isNotNull);
        ...
        skip:
            'chasm returns JSON-encoded "binary" placeholder for binary response types');
    ...
    test('downloadBinaryMock', () async {
      ...
      try {
        ...
        skip:
            'Dart SDK binary response cast (List<int>) needs lenient handling for the WithHTTPInfo wrapper');
