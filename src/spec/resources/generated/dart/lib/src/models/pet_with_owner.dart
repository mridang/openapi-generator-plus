...
class PetWithOwner {
  ...
  factory PetWithOwner.fromJson(Map<String, dynamic> json) {
    return PetWithOwner(
      ...
      tags: (json['tags'] as List?)?.map((e) => Tag.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  @override
  int get hashCode => Object.hashAll([id, name, category, photoUrls, tags, status, ownerName, ownerEmail]);
}
