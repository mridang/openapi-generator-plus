...
class Employee {
  ...
  const Employee({required this.name, this.department});

  /// Creates a [Employee] from a JSON map.
  factory Employee.fromJson(Map<String, dynamic> json) {
    ...
    if (json['name'] == null) {
      throw SerializationError("Missing required field 'name' for Employee");
    }
    return Employee(
  ...
  @override
  int get hashCode => Object.hashAll([name, department]);
}
