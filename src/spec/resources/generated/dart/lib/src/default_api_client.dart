...
class DefaultApiClient implements ApiClient {
  ...
  /// leaking a raw `dart:io` FileSystemException / TlsException — matching
  /// the typed-error behaviour of the other SDKs. A try/catch cannot wrap
  /// a call made from an initializer list, hence the factory. The public
  /// constructor API is unchanged.
  factory DefaultApiClient({TransportOptions? transportOptions}) {
    ...
    return DefaultApiClient._(
      ...
      _buildProxyAuthHeader(options.proxy),
    );
  }
