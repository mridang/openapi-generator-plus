...
func (c *fakeTokenClient) SendRequestWithOptions(method, url string, headers map[string]string, body interface{}, opts *auth.RequestOptions) (*auth.HttpResponse, error) {
	c.LastURL = url
	if opts != nil {
