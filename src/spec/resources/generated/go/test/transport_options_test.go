...
func TestTransportOptions_CACertPathDefaultsToEmpty(t *testing.T) {
	opts := petstore.NewTransportOptionsBuilder().Build()
	if opts.CACertPath() != "" {
...
func TestTransportOptions_ProxyDefaultsToNil(t *testing.T) {
	opts := petstore.NewTransportOptionsBuilder().Build()
	if opts.Proxy() != nil {
...
func TestTransportOptions_MaxRedirectsDefaultsToNil(t *testing.T) {
	opts := petstore.NewTransportOptionsBuilder().Build()
