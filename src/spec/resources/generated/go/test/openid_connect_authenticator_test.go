...
func (c *fakeOIDCClient) SendRequestWithOptions(method, url string, headers map[string]string, body interface{}, opts *auth.RequestOptions) (*auth.HttpResponse, error) {
	_ = opts
	c.LastMethod = method
	c.LastURL = url
	if body != nil {
