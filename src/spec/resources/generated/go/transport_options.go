...
type TransportOptions struct {
	...
	// timeout is the end-to-end request timeout. Covers the entire request
	// lifecycle: connection, TLS handshake, sending the request body, and
	// reading the response. A zero value means no timeout.
...
func (t *TransportOptions) Timeout() time.Duration { return t.timeout }
...
// Timeout sets the end-to-end request timeout.
func (b *TransportOptionsBuilder) Timeout(val time.Duration) *TransportOptionsBuilder {
	b.timeout = val
	return b
}
