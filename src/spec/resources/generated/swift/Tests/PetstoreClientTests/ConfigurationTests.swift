...
final class ConfigurationTests: XCTestCase {
  ...
  func testDefaultValues() {
    ...
    XCTAssertEqual(config.baseURL, "/api/v3")
  ...
  func testDefaultHeadersCopyIsolation() {
    ...
    XCTAssertNil(
      config.defaultHeaders["X-Mutated"],
