...
final class PetApiTests {
  ...
  @Test func testSetPetAvatarHonoursSelectedRequestContentType() async throws {
    ...
    #expect(
      defaultClient.lastHeaders["Content-Type"] == "image/jpeg",
