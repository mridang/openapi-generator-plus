...
public final class DefaultApiClient: ApiClient, @unchecked Sendable {
    ...
    public func sendRequest(method: String, url: String, headers: [String: String], body: Any?, noRedirect: Bool = false) async throws -> HttpResponse {
        ...
        do {
            ...
            let activeSession: URLSession = noRedirect
...
private final class SessionDelegate: NSObject, URLSessionDelegate, URLSessionTaskDelegate, @unchecked Sendable {
    ...
    func urlSession(
        ...
        let hasBody = (redirectRequest.httpBody != nil)
