...
public final class TransportOptions: Sendable {
  ...
  /// End-to-end request timeout in seconds. Covers the entire request
...
public final class TransportOptionsBuilder {
  ...
  /// Sets the end-to-end request timeout in seconds.
  @discardableResult
  public func timeout(_ val: TimeInterval) -> TransportOptionsBuilder {
    self.timeout = val
    return self
  }
