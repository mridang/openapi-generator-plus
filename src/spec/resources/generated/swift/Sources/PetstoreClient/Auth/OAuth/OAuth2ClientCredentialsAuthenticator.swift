...
extension OAuth2ClientCredentialsAuthenticator: CustomStringConvertible,
  CustomDebugStringConvertible
{
  ...
  public var description: String {
    "\(type(of: self))(host: \(_host), clientID: \(clientID), clientSecret: ***, tokenURL: \(tokenURL), scopes: \(scopes), clientAuthMethod: \(clientAuthMethod))"
  }
