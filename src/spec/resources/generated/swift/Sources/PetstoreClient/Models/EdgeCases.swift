...
public struct EdgeCases: Codable, Sendable, Equatable, Hashable {
    ...
    public init(
        freeFormAny: AnyCodable? = nil, favoriteColor: Color? = nil, permissionsNote: String? = nil, and: Bool? = nil,
        or: Bool? = nil, not: Bool? = nil, _class: String? = nil, _return: String? = nil,
        retryAfter: TimeInterval? = nil, expiresAt: Date? = nil
    ) {
