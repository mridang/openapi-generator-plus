...
public class OAuth2ImplicitAuthenticator implements HttpAwareAuthenticator {
  ...
  public void setAccessToken(String token) {
     ...
     * RFC 7230 §3.2.6 check. setAccessToken would otherwise let a
     * caller stash a CR/LF-bearing token and only fail at the next
     * API call via the Authorization-header concat, allowing HTTP
     * header injection from a redirect-fragment-derived value. */
    if (token != null) {
