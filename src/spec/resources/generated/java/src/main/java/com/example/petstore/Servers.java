...
public final class Servers {
     ...
     */
    public static final ServerConfiguration SERVER_0 = new ServerConfiguration(
            "/api/v3",
     ...
     */
    public static final ServerConfiguration SERVER_1 = new ServerConfiguration(
