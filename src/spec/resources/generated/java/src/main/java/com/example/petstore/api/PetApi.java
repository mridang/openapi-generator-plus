...
import com.example.petstore.models.setPetAvatarThumbnail_request;
import com.example.petstore.models.setPetAvatar_request;
...
public class PetApi extends BaseApi {
    ...
    private static final TypeReference<Pet> addPetTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<List<Photo>> addPetPhotosTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<InputStream> downloadPetDocumentTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<List<Pet>> findPetsByStatusTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<Pet> getExternalPetInfoTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<Pet> getMultiServerPetInfoTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<InputStream> getPetAvatarTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<byte[]> getPetAvatarThumbnailTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<Pet> getPetByIdTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<PetPassport> getPetPassportTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<InputStream> getPetPhotoTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<Pet> getPetTagTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<Pet> getStagingPetInfoTypeRef =
            new TypeReference<>() {};

    private static final TypeReference<Pet> updatePetTypeRef =
            new TypeReference<>() {};
    ...
    public sealed interface GetStagingPetInfoServer {
        ...
        /** Staging server */
        record StagingServer(Environment environment, Version version) implements GetStagingPetInfoServer {
    ...
    public ApiResult<Pet> addPetWithHttpInfo(PetStoreBearerAuthenticator auth, Pet pet) throws ApiException {
    ...
    public ApiResult<Pet> addPetWithHttpInfo(ApiKeyHeaderAuthenticator auth, Pet pet) throws ApiException {
        return addPetInternal(auth, pet);
    }
    ...
    public ApiResult<List<Photo>> addPetPhotosWithHttpInfo(Long petId, AddPetPhotosOptions options) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
        ...
        String path =
                "/pet/{petId}/photos"
                        .replace(
                                "{" + "petId" + "}",
                                (String) ValueSerializer.serializeStyled("petId", petId, "path", "Long", null, "simple", false));
        Map<String, Object> queryParams = new HashMap<>();
        Map<String, String> headerParams = new HashMap<>();
     ...
     * @throws ApiException if fails to make API call
     */
    public void deletePet(MachineAuthClientCredentialsAuthenticator auth, Long petId) throws ApiException {
        deletePetWithHttpInfo(auth, petId);
    }

    public ApiResult<Void> deletePetWithHttpInfo(MachineAuthClientCredentialsAuthenticator auth, Long petId) throws ApiException {
    ...
    public ApiResult<Void> deletePetWithHttpInfo(AdminBasicAuthenticator auth, Long petId) throws ApiException {
        return deletePetInternal(auth, petId);
    }
    ...
    public ApiResult<InputStream> downloadPetDocumentWithHttpInfo(Long petId, Long documentId) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
        ...
        String path =
                "/pet/{petId}/documents/{documentId}"
                        ...
                        .replace(
                                "{" + "documentId" + "}",
                                (String) ValueSerializer.serializeStyled("documentId", documentId, "path", "Long", null, "simple", false));
        Map<String, Object> queryParams = new HashMap<>();
        Map<String, String> headerParams = new HashMap<>();
        return invokeApiForResult(
                "GET",
    ...
    public ApiResult<List<Pet>> findPetsByStatusWithHttpInfo(FindPetsByStatusOptions options) throws ApiException {
        String path = "/pet/findByStatus";
        Map<String, Object> queryParams = new HashMap<>();
        if (options.status() != null) {
            queryParams.put("status", ValueSerializer.serializeStyled("status", options.status(), "query", "String", null, "form", true));
        }
    ...
    @Nullable
    public Pet getExternalPetInfo(Long petId, @Nullable GetExternalPetInfoServer server) throws ApiException {
        return getExternalPetInfoWithHttpInfo(petId, server).data();
    }

    public ApiResult<Pet> getExternalPetInfoWithHttpInfo(Long petId, @Nullable GetExternalPetInfoServer server) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
        ...
        } else if ("https://external-api.example.com/v1".startsWith("http://") || "https://external-api.example.com/v1".startsWith("https://")) {
    ...
    @Nullable
    public Pet getMultiServerPetInfo(Long petId, @Nullable GetMultiServerPetInfoServer server) throws ApiException {
        return getMultiServerPetInfoWithHttpInfo(petId, server).data();
    }

    public ApiResult<Pet> getMultiServerPetInfoWithHttpInfo(Long petId, @Nullable GetMultiServerPetInfoServer server) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
    ...
    public ApiResult<InputStream> getPetPhotoWithHttpInfo(Long petId, Long photoId) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
        ...
        String path =
                "/pet/{petId}/photos/{photoId}"
                        ...
                        .replace(
                                "{" + "photoId" + "}",
                                (String) ValueSerializer.serializeStyled("photoId", photoId, "path", "Long", null, "simple", false));
        Map<String, Object> queryParams = new HashMap<>();
        Map<String, String> headerParams = new HashMap<>();
        return invokeApiForResult(
                "GET",
    ...
    public ApiResult<Pet> getPetTagWithHttpInfo(Long petId, String tagName, GetPetTagOptions options) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
        ...
        String path =
                "/pet/{petId}/tag/{tagName}"
                        .replace(
                                "{" + "petId" + "}",
                                (String) ValueSerializer.serializeStyled("petId", petId, "path", "Long", null, "matrix", false))
                        .replace(
                                "{" + "tagName" + "}",
                                (String) ValueSerializer.serializeStyled("tagName", tagName, "path", "String", null, "label", false));
        Map<String, Object> queryParams = new HashMap<>();
        if (options.colors() != null) {
            queryParams.put("colors", ValueSerializer.serializeStyled("colors", options.colors(), "query", "List<String>", "pipes", "pipeDelimited", false));
        }
        if (options.sizes() != null) {
            queryParams.put("sizes", ValueSerializer.serializeStyled("sizes", options.sizes(), "query", "List<String>", "ssv", "spaceDelimited", false));
        }
        {
            Object _filterVal = ValueSerializer.serializeStyled("filter", options.filter(), "query", "String", null, "form", true);
            if (_filterVal != null) {
    ...
    @Nullable
    public Pet getStagingPetInfo(Long petId, @Nullable GetStagingPetInfoServer server) throws ApiException {
        return getStagingPetInfoWithHttpInfo(petId, server).data();
    }

    public ApiResult<Pet> getStagingPetInfoWithHttpInfo(Long petId, @Nullable GetStagingPetInfoServer server) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
        ...
        } else if ("https://{environment}.example.com/api/{version}".startsWith("http://") || "https://{environment}.example.com/api/{version}".startsWith("https://")) {
    ...
    public ApiResult<Void> setPetAvatarWithHttpInfo(Long petId, InputStream body) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
    ...
    public void setPetAvatarThumbnail(Long petId, SetPetAvatarThumbnailRequest setPetAvatarThumbnailRequest) throws ApiException {
        setPetAvatarThumbnailWithHttpInfo(petId, setPetAvatarThumbnailRequest);
    }

    public ApiResult<Void> setPetAvatarThumbnailWithHttpInfo(Long petId, SetPetAvatarThumbnailRequest setPetAvatarThumbnailRequest) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
    ...
    @Nullable
    public ApiResponse uploadPetCertificate(Long petId, UploadPetCertificateOptions options) throws ApiException {
        return uploadPetCertificateWithHttpInfo(petId, options).data();
    }

    public ApiResult<ApiResponse> uploadPetCertificateWithHttpInfo(Long petId, UploadPetCertificateOptions options) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
    ...
    @Nullable
    public ApiResponse uploadPetDocument(Long petId, UploadPetDocumentOptions options) throws ApiException {
        return uploadPetDocumentWithHttpInfo(petId, options).data();
    }

    public ApiResult<ApiResponse> uploadPetDocumentWithHttpInfo(Long petId, UploadPetDocumentOptions options) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
