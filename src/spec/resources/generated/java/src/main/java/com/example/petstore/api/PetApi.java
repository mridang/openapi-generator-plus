...
public class PetApi extends BaseApi {
     ...
     */
    @Nullable
    public PetTreatment addPetTreatment(PetStoreBasicAuthenticator auth, Long petId, PetTreatment petTreatment) throws ApiException {
        return addPetTreatmentWithHttpInfo(auth, petId, petTreatment).data();
    }

    public ApiResult<PetTreatment> addPetTreatmentWithHttpInfo(PetStoreBasicAuthenticator auth, Long petId, PetTreatment petTreatment) throws ApiException {
        return addPetTreatmentInternal(auth, petId, petTreatment);
    }

    @Nullable
    public PetTreatment addPetTreatment(PetStoreBearerAuthenticator auth, Long petId, PetTreatment petTreatment) throws ApiException {
        return addPetTreatmentWithHttpInfo(auth, petId, petTreatment).data();
    }

    public ApiResult<PetTreatment> addPetTreatmentWithHttpInfo(PetStoreBearerAuthenticator auth, Long petId, PetTreatment petTreatment) throws ApiException {
        return addPetTreatmentInternal(auth, petId, petTreatment);
    }

    private ApiResult<PetTreatment> addPetTreatmentInternal(Authenticator auth, Long petId, PetTreatment petTreatment) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
     ...
     * @throws ApiException if fails to make API call
     */
    public void deletePet(MachineAuthClientCredentialsAuthenticator auth, Long petId, @Nullable DeletePetOptions options) throws ApiException {
        deletePetWithHttpInfo(auth, petId, options);
    }

    public ApiResult<Void> deletePetWithHttpInfo(MachineAuthClientCredentialsAuthenticator auth, Long petId, @Nullable DeletePetOptions options) throws ApiException {
        return deletePetInternal(auth, petId, options);
    }

    public void deletePet(AdminBasicAuthenticator auth, Long petId, @Nullable DeletePetOptions options) throws ApiException {
        deletePetWithHttpInfo(auth, petId, options);
    }

    public ApiResult<Void> deletePetWithHttpInfo(AdminBasicAuthenticator auth, Long petId, @Nullable DeletePetOptions options) throws ApiException {
        return deletePetInternal(auth, petId, options);
    }

    private ApiResult<Void> deletePetInternal(Authenticator auth, Long petId, @Nullable DeletePetOptions options) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
        ...
        if (options != null && options.apiKey() != null) {
            cookieJoiner.add("api_key=" + ValueSerializer.serializeStyled("api_key", options.apiKey(), "cookie", "String", null, "form", true));
        }
    ...
    public ApiResult<Pet> getPetByIdWithHttpInfo(Long petId, @Nullable GetPetByIdServer server) throws ApiException {
        if (petId == null) {
            throw new IllegalArgumentException(
    ...
    public ApiResult<Pet> getPetTagWithHttpInfo(Long petId, String tagName, GetPetTagOptions options) throws ApiException {
        ...
        if (options.filter() != null) {
            queryParams.put("filter", ValueSerializer.serializeStyled("filter", options.filter(), "query", "String", null, "form", true));
        } else {
