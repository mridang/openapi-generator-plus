 ...
 *
 * <p>These tests verify RFC 9110 compliant content negotiation with quality weights.
 */
class HeaderSelectorTest {
  ...
  class SelectHeadersTests {
    ...
    void shouldPrioritizeApplicationJsonWithQualityWeight() {
      Map<String, String> headers =
          headerSelector.selectHeaders(
              new String[] {"text/html", "application/json"}, "application/json", false);
    ...
    void shouldFilterOutEmptyEntries() {
      Map<String, String> headers =
          headerSelector.selectHeaders(
              new String[] {"", "application/json", null}, "application/json", false);
      assertEquals("application/json", headers.get("Accept"));
    }
  ...
  class QualityWeightFormattingTests {
    ...
    void shouldNotAddQualityWeightForWeight1000() {
      Map<String, String> headers =
          headerSelector.selectHeaders(
              new String[] {"application/json", "text/html"}, "application/json", false);
      String accept = headers.get("Accept");
      assertNotNull(accept);
