...
class OpenIdConnectAuthenticatorTest extends TestCase
{
    ...
    public function testObtainsTokenViaDiscoveredEndpoint(): void
    {
        ...
        $this->assertStringContainsString('grant_type=authorization_code', (string) $tokenRequest['body']);
        $this->assertStringContainsString('code=oidc-code-123', (string) $tokenRequest['body']);
    }
