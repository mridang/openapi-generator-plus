...
class OAuth2PasswordAuthenticator extends BaseAuthenticator implements HttpAwareAuthenticator
{
    ...
    /**
     * Masks the client secret and the resource owner password so neither
     * leaks through var_dump() / print_r() / stack traces / error logs.
     *
