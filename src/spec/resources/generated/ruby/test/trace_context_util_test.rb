...
describe Petstore::Client::TraceContextUtil do
  parallelize_me!

  describe '.inject_trace_context' do
    it 'is a no-op without tracer' do
      headers = {}
      Petstore::Client::TraceContextUtil.inject_trace_context(headers)
    ...
    it 'formats trace flags correctly on the active span' do
      ...
      sampled_headers = {}
      unsampled_headers = {}
      sampled.in_span('sampled') { Petstore::Client::TraceContextUtil.inject_trace_context(sampled_headers) }
      unsampled.in_span('unsampled') { Petstore::Client::TraceContextUtil.inject_trace_context(unsampled_headers) }
