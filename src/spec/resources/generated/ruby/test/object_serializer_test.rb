...
describe PetstoreClient::ObjectSerializer do
  ...
  describe 'enum unknown value detection' do
    before do
      stub_const_name = :TestStatusEnumDeserialize
      unless PetstoreClient::Models.const_defined?(stub_const_name)
        klass = Class.new do
          VALUES = %w[placed approved delivered].freeze
        end
        PetstoreClient::Models.const_set(stub_const_name, klass)
      end
    end
  ...
  describe 'enum frozen consts' do
    before do
      stub_const_name = :TestStatusEnumValidate
      unless PetstoreClient::Models.const_defined?(stub_const_name)
        klass = Class.new do
