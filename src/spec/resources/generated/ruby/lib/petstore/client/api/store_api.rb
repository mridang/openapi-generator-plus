  ...
  module Api
    ...
    class StoreApi < BaseApi
      ...
      def delete_order_with_http_info(order_id)
        ...
        path = path.gsub('{orderId}', ::Petstore::Client::ValueSerializer.serialize_styled('orderId', order_id, :path, 'Integer', nil, 'simple', false).to_s)
      ...
      def get_by_swatch_with_http_info(path_swatch, options = nil)
        ...
        path = path.gsub('{pathSwatch}', ::Petstore::Client::ValueSerializer.serialize_styled('pathSwatch', path_swatch, :path, 'Swatch', nil, 'simple', false).to_s)
        # @type var query_params: Hash[String, untyped]
        query_params = {}
        ...
        # @type var header_params: Hash[String, String]
        header_params = {}
        header_params['Preferred-Swatch'] = ::Petstore::Client::ValueSerializer.serialize_styled('Preferred-Swatch', options.preferred_swatch, :header, 'Swatch', nil, 'simple', false).to_s unless options.nil? || options.preferred_swatch.nil?
        request_body = nil
        invoke_api_for_result(
      ...
      def place_order_with_http_info(order = nil)
        ...
        request_body = ::Petstore::Client::ObjectSerializer.encode_oneof_body(order, 'Order')
        invoke_api_for_result(
