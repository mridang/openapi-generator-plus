...
require_relative 'get_external_pet_info_server_server0'
require_relative 'get_multi_server_pet_info_server'
require_relative 'get_multi_server_pet_info_server_region'
require_relative 'get_multi_server_pet_info_server_primary'
require_relative 'get_multi_server_pet_info_server_regional'
require_relative 'get_pet_by_id_server'
require_relative 'get_pet_by_id_server_cdn_backed_read_endpoint_for_pet_details'
require_relative 'get_staging_pet_info_server'
require_relative 'get_staging_pet_info_server_environment'
require_relative 'get_staging_pet_info_server_version'
require_relative 'get_staging_pet_info_server_staging_server'
  ...
  module Api
    ...
    class PetApi < BaseApi
      ...
      def add_pet_with_http_info(pet, options = nil)
        ...
        request_body = ::Petstore::Client::ObjectSerializer.encode_oneof_body(pet, 'Pet')
      ...
      def add_pet_photos_with_http_info(pet_id, options)
        ...
        path = path.gsub('{petId}', ::Petstore::Client::ValueSerializer.serialize_styled('petId', pet_id, :path, 'Integer', nil, 'simple', false).to_s)
        # @type var query_params: Hash[String, untyped]
        query_params = {}
        # @type var header_params: Hash[String, String]
        header_params = {}
      ...
      def add_pet_treatment_with_http_info(pet_id, pet_treatment, options = nil)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Petstore::Client::ObjectSerializer.encode_oneof_body(pet_treatment, 'PetTreatment')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def download_pet_document_with_http_info(pet_id, document_id)
        ...
        path = path.gsub('{petId}', ::Petstore::Client::ValueSerializer.serialize_styled('petId', pet_id, :path, 'Integer', nil, 'simple', false).to_s)
        path = path.gsub('{documentId}', ::Petstore::Client::ValueSerializer.serialize_styled('documentId', document_id, :path, 'Integer', nil, 'simple', false).to_s)
        # @type var query_params: Hash[String, untyped]
        query_params = {}
        # @type var header_params: Hash[String, String]
        header_params = {}
      ...
      def get_pet_by_name_with_http_info(name, options)
        ...
        path = path.gsub('{name}', ::Petstore::Client::ValueSerializer.serialize_styled('name', name, :path, 'String', nil, 'simple', false).to_s)
        # @type var query_params: Hash[String, untyped]
        query_params = {}
      ...
      def get_pet_photo_with_http_info(pet_id, photo_id)
        ...
        path = path.gsub('{petId}', ::Petstore::Client::ValueSerializer.serialize_styled('petId', pet_id, :path, 'Integer', nil, 'simple', false).to_s)
        path = path.gsub('{photoId}', ::Petstore::Client::ValueSerializer.serialize_styled('photoId', photo_id, :path, 'Integer', nil, 'simple', false).to_s)
        # @type var query_params: Hash[String, untyped]
        query_params = {}
        # @type var header_params: Hash[String, String]
        header_params = {}
      ...
      def get_pet_tag_with_http_info(pet_id, tag_name, options = nil)
        ...
        path = path.gsub('{petId}', ::Petstore::Client::ValueSerializer.serialize_styled('petId', pet_id, :path, 'Integer', nil, 'matrix', false).to_s)
        path = path.gsub('{tagName}', ::Petstore::Client::ValueSerializer.serialize_styled('tagName', tag_name, :path, 'String', nil, 'label', false).to_s)
        # @type var query_params: Hash[String, untyped]
        query_params = {}
      ...
      def set_pet_avatar_thumbnail_with_http_info(pet_id, set_pet_avatar_thumbnail_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Petstore::Client::ObjectSerializer.encode_oneof_body(set_pet_avatar_thumbnail_request, 'SetPetAvatarThumbnailRequest')
        invoke_api_for_result(
          :PUT, path, query_params, header_params, request_body,
          [],
          'application/json',
