...
def chasm_container(proxy_network):
    ...
    key_path = os.path.join(host_app_path, 'test', 'fixtures', 'certs', 'server-key.pem')
    ...
    container = (
        ...
        .with_command('mock /tmp/openapi.yaml --host 0.0.0.0 --tls-cert /certs/cert.pem --tls-key /certs/key.pem --tls-port 8443')
