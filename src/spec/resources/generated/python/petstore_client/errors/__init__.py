...
from petstore_client.errors.oauth2_server_exception import OAuth2ServerException
from petstore_client.errors.oauth2_token_exception import OAuth2TokenException
