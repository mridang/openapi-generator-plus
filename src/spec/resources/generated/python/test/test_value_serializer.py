...
class TestSimpleStyleBackwardCompatibility:
    ...
    def test_path_serialization_is_final_and_must_not_be_double_encoded(self) -> None:
        ...
        space = ValueSerializer.serialize_styled('id', 'a b', 'path', 'string', None, 'simple', False)
        assert space == 'a%20b'
        ...
        slash = ValueSerializer.serialize_styled('id', 'a/b', 'path', 'string', None, 'simple', False)
        assert slash == 'a%2Fb'
