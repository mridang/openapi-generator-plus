...
class TestOAuth2TokenManager:
    ...
    def test_stores_refresh_token_from_response(self) -> None:
        manager = OAuth2TokenManager()
        mock_client = MagicMock()
        mock_client.send_request.return_value = ApiResponse(
            status_code=200,
    ...
    def test_detects_token_expiry_and_refetches(self) -> None:
        manager = OAuth2TokenManager()
        mock_client = MagicMock()
    ...
    def test_raises_error_when_token_request_fails(self) -> None:
        manager = OAuth2TokenManager()
        mock_client = MagicMock()
        mock_client.send_request.return_value = ApiResponse(
            status_code=401,
