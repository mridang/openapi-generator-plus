...
class TestInjectTraceContext:
    ...
    def test_should_inject_traceparent_with_mock_propagator(self):
    ...
    def test_should_not_inject_traceparent_without_otel(self):
        headers: dict[str, str] = {}
        inject_trace_context(headers)
        assert 'traceparent' not in headers

    def test_should_not_throw_any_exception(self):
        headers: dict[str, str] = {}
        inject_trace_context(headers)
