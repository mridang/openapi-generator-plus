...
class TestMatrixStyle:
    def test_scalar_returns_semicolon_prefixed_name_value(self):
        assert (
            ValueSerializer.serialize_styled('color', 'blue', 'path', 'string', None, 'matrix', True) == ';color=blue'
        )

    def test_array_with_explode_false_joins_with_comma(self):
        assert (
            ValueSerializer.serialize_styled('color', ['blue', 'black'], 'path', 'array', None, 'matrix', False)
            == ';color=blue,black'
        )

    def test_array_with_explode_true_repeats_name(self):
        assert (
...
class TestLabelStyle:
    def test_scalar_returns_dot_prefixed_value(self):
    ...
    def test_array_with_explode_true_joins_with_dot(self):
        assert (
...
class TestSpaceDelimitedStyle:
    def test_array_joins_with_space(self):
        assert (
    ...
    def test_scalar_returns_stringified_value(self):
        assert (
...
class TestPipeDelimitedStyle:
    def test_array_joins_with_pipe(self):
        assert (
...
class TestFormStyleWithExplode:
    ...
    def test_array_with_explode_true_returns_list(self):
...
class TestNullStyleFallback:
    def test_path_with_null_style_behaves_like_simple(self):
