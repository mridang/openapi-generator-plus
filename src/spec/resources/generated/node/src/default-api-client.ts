...
export class DefaultApiClient implements ApiClient {
  ...
  constructor(transportOptions?: TransportOptions) {
    ...
    if (this.transportOptions.caCertPath != null) {
      const caCertPath = this.transportOptions.caCertPath;
      try {
    ...
    try {
      ...
      if (this.transportOptions.followRedirects && !noRedirect) {
        ...
        while (hops < maxRedirects && DefaultApiClient.isRedirectStatus(response.status)) {
          ...
          response = await fetch(nextUrl, redirectOptions as Parameters<typeof fetch>[1]);
          hops++;
        }
