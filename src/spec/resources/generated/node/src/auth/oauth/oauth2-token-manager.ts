...
export class OAuth2TokenManager {
  ...
  async getAccessToken(
    ...
    if (
      ...
      (this.tokenExpiry === null ||
        Date.now() <
          this.tokenExpiry - OAuth2TokenManager.EXPIRY_SAFETY_MARGIN_MS)
    ) {
  ...
  private async fetchToken(
    ...
    if (response.statusCode < 200 || response.statusCode >= 300) {
      ...
      throw OAuth2TokenManager.parseOAuth2ServerError(
        response.statusCode,
        response.body,
      );
    }
   ...
   */
  private static parseOAuth2ServerError(
    statusCode: number,
    body: string,
  ): OAuth2ServerError {
    let parsed: unknown;
 ...
 */
export class OAuth2ServerError extends OpenAPIError {
  constructor(
