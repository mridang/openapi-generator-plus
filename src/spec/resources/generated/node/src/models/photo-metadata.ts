...
export class PhotoMetadata {
  ...
  equals(other: unknown): boolean {
    ...
    if (!PhotoMetadata.__deepEquals(this.caption, (other as PhotoMetadata).caption)) {
      return false;
    }
    if (!PhotoMetadata.__deepEquals(this.isPrimary, (other as PhotoMetadata).isPrimary)) {
      return false;
    }
    if (!PhotoMetadata.__deepEquals(this.takenAt, (other as PhotoMetadata).takenAt)) {
      return false;
    }
    if (!PhotoMetadata.__deepEquals(this.location, (other as PhotoMetadata).location)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => PhotoMetadata.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => PhotoMetadata.__deepEquals(v, w)));
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !PhotoMetadata.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === 'object' && typeof b === 'object') {
      ...
      return ak.every((k) => Object.prototype.hasOwnProperty.call(br, k) && PhotoMetadata.__deepEquals(ar[k], br[k]));
    }
    return false;
  }
}
