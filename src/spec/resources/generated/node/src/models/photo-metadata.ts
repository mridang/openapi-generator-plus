...
export class PhotoMetadata {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !PhotoMetadata.__deepEquals(
        this.caption,
        (other as PhotoMetadata).caption,
      )
    ) {
      return false;
    }
    if (
      !PhotoMetadata.__deepEquals(
        this.isPrimary,
        (other as PhotoMetadata).isPrimary,
      )
    ) {
      return false;
    }
    if (
      !PhotoMetadata.__deepEquals(
        this.takenAt,
        (other as PhotoMetadata).takenAt,
      )
    ) {
      return false;
    }
    if (
      !PhotoMetadata.__deepEquals(
        this.location,
        (other as PhotoMetadata).location,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => PhotoMetadata.__deepEquals(v, w)),
      );
    }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          PhotoMetadata.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
