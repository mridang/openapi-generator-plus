...
export class PetWithOwner {
  ...
  equals(other: unknown): boolean {
    ...
    if (!PetWithOwner.__deepEquals(this.category, (other as PetWithOwner).category)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.photoUrls, (other as PetWithOwner).photoUrls)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.tags, (other as PetWithOwner).tags)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.status, (other as PetWithOwner).status)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.location, (other as PetWithOwner).location)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.homepageUrl, (other as PetWithOwner).homepageUrl)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.thumbnailRef, (other as PetWithOwner).thumbnailRef)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.linkTemplate, (other as PetWithOwner).linkTemplate)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.ownerEmail, (other as PetWithOwner).ownerEmail)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.weightKg, (other as PetWithOwner).weightKg)) {
      return false;
    }
    if (!PetWithOwner.__deepEquals(this.ownerName, (other as PetWithOwner).ownerName)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => PetWithOwner.__deepEquals(v, w)));
    }
    ...
    if (typeof a === 'object' && typeof b === 'object') {
      ...
      return ak.every((k) => Object.prototype.hasOwnProperty.call(br, k) && PetWithOwner.__deepEquals(ar[k], br[k]));
    }
    return false;
  }
}
