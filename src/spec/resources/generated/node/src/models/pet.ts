...
export class Pet {
  ...
  equals(other: unknown): boolean {
    ...
    if (!Pet.__deepEquals(this.id, (other as Pet).id)) {
      return false;
    }
    if (!Pet.__deepEquals(this.name, (other as Pet).name)) {
      return false;
    }
    if (!Pet.__deepEquals(this.category, (other as Pet).category)) {
      return false;
    }
    if (!Pet.__deepEquals(this.photoUrls, (other as Pet).photoUrls)) {
      return false;
    }
    if (!Pet.__deepEquals(this.tags, (other as Pet).tags)) {
      return false;
    }
    if (!Pet.__deepEquals(this.status, (other as Pet).status)) {
      return false;
    }
    if (!Pet.__deepEquals(this.location, (other as Pet).location)) {
      return false;
    }
    if (!Pet.__deepEquals(this.homepageUrl, (other as Pet).homepageUrl)) {
      return false;
    }
    if (!Pet.__deepEquals(this.thumbnailRef, (other as Pet).thumbnailRef)) {
      return false;
    }
    if (!Pet.__deepEquals(this.linkTemplate, (other as Pet).linkTemplate)) {
      return false;
    }
    if (!Pet.__deepEquals(this.ownerEmail, (other as Pet).ownerEmail)) {
      return false;
    }
    if (!Pet.__deepEquals(this.weightKg, (other as Pet).weightKg)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => Pet.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => Pet.__deepEquals(v, w)));
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !Pet.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
