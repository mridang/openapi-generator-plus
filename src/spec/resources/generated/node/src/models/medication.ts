...
export class Medication {
  ...
  equals(other: unknown): boolean {
    ...
    if (!Medication.__deepEquals(this.drugName, (other as Medication).drugName)) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => Medication.__deepEquals(v, w)));
    }
    ...
    if (typeof a === 'object' && typeof b === 'object') {
      ...
      return ak.every((k) => Object.prototype.hasOwnProperty.call(br, k) && Medication.__deepEquals(ar[k], br[k]));
    }
    return false;
  }
}
