...
export class SetPetAvatarRequest {
  ...
  equals(other: unknown): boolean {
    ...
    if (!SetPetAvatarRequest.__deepEquals(this.data, (other as SetPetAvatarRequest).data)) {
      return false;
    }
    if (!SetPetAvatarRequest.__deepEquals(this.mimeType, (other as SetPetAvatarRequest).mimeType)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => SetPetAvatarRequest.__deepEquals(v, w)));
    }
    ...
    if (typeof a === 'object' && typeof b === 'object') {
      ...
      return ak.every(
        (k) => Object.prototype.hasOwnProperty.call(br, k) && SetPetAvatarRequest.__deepEquals(ar[k], br[k])
      );
    }
    return false;
  }
