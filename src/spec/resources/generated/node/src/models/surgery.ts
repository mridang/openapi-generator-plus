...
export class Surgery {
  ...
  equals(other: unknown): boolean {
    ...
    if (!Surgery.__deepEquals(this.procedureName, (other as Surgery).procedureName)) {
      return false;
    }
    if (!Surgery.__deepEquals(this.durationMinutes, (other as Surgery).durationMinutes)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (typeof a === 'object' && typeof b === 'object') {
      ...
      return ak.every((k) => Object.prototype.hasOwnProperty.call(br, k) && Surgery.__deepEquals(ar[k], br[k]));
    }
    return false;
  }
}
