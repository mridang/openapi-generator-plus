...
export class Employee {
  ...
  equals(other: unknown): boolean {
    ...
    if (!Employee.__deepEquals(this.name, (other as Employee).name)) {
      return false;
    }
    if (
      !Employee.__deepEquals(this.department, (other as Employee).department)
    ) {
      return false;
    }
    return true;
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => Employee.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => Employee.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !Employee.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          Employee.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
