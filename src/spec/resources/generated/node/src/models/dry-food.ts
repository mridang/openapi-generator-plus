...
export class DryFood {
  ...
  constructor(data?: Partial<DryFood>) {
    ...
    if (this.foodType != null && typeof this.foodType !== "string") {
      throw new TypeError(
        `foodType must be a string, got ${typeof this.foodType}`,
      );
    }
    if (this.weightKg != null && typeof this.weightKg !== "number") {
      throw new TypeError(
        `weightKg must be a number, got ${typeof this.weightKg}`,
      );
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof DryFood)) {
      return false;
    }
    if (!DryFood.__deepEquals(this.foodType, (other as DryFood).foodType)) {
      return false;
    }
    if (!DryFood.__deepEquals(this.weightKg, (other as DryFood).weightKg)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => DryFood.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => DryFood.__deepEquals(v, w)));
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !DryFood.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          DryFood.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
