...
export class Category {
  ...
  equals(other: unknown): boolean {
    ...
    if (!Category.__deepEquals(this.id, (other as Category).id)) {
      return false;
    }
    if (!Category.__deepEquals(this.name, (other as Category).name)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => Category.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => Category.__deepEquals(v, w)));
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !Category.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === 'object' && typeof b === 'object') {
      ...
      return ak.every((k) => Object.prototype.hasOwnProperty.call(br, k) && Category.__deepEquals(ar[k], br[k]));
    }
    return false;
  }
}
