...
export class TreeNode {
  ...
  constructor(data?: Partial<TreeNode>) {
    ...
    if (this.value != null && typeof this.value !== "string") {
      throw new TypeError(`value must be a string, got ${typeof this.value}`);
    }
  }
  ...
  equals(other: unknown): boolean {
    ...
    if (!TreeNode.__deepEquals(this.value, (other as TreeNode).value)) {
      return false;
    }
    if (!TreeNode.__deepEquals(this.child, (other as TreeNode).child)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => TreeNode.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => TreeNode.__deepEquals(v, w)),
      );
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !TreeNode.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          TreeNode.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
