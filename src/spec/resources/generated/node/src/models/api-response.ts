...
export class ApiResponse {
  ...
  equals(other: unknown): boolean {
    ...
    if (!ApiResponse.__deepEquals(this.code, (other as ApiResponse).code)) {
      return false;
    }
    if (!ApiResponse.__deepEquals(this.type, (other as ApiResponse).type)) {
      return false;
    }
    if (!ApiResponse.__deepEquals(this.message, (other as ApiResponse).message)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => ApiResponse.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => ApiResponse.__deepEquals(v, w)));
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !ApiResponse.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === 'object' && typeof b === 'object') {
      ...
      return ak.every((k) => Object.prototype.hasOwnProperty.call(br, k) && ApiResponse.__deepEquals(ar[k], br[k]));
    }
    return false;
  }
}
