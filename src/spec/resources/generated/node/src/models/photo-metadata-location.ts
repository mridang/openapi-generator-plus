...
export class PhotoMetadataLocation {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof PhotoMetadataLocation)) {
      return false;
    }
    if (!PhotoMetadataLocation.__deepEquals(this.lat, (other as PhotoMetadataLocation).lat)) {
      return false;
    }
    if (!PhotoMetadataLocation.__deepEquals(this.lng, (other as PhotoMetadataLocation).lng)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => PhotoMetadataLocation.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => PhotoMetadataLocation.__deepEquals(v, w)));
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !PhotoMetadataLocation.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === 'object' && typeof b === 'object') {
      ...
      return ak.every(
        (k) => Object.prototype.hasOwnProperty.call(br, k) && PhotoMetadataLocation.__deepEquals(ar[k], br[k])
      );
    }
    return false;
  }
