...
export class PhotoMetadataLocation {
  ...
  equals(other: unknown): boolean {
    ...
    if (
      !PhotoMetadataLocation.__deepEquals(
        this.lat,
        (other as PhotoMetadataLocation).lat,
      )
    ) {
      return false;
    }
    if (
      !PhotoMetadataLocation.__deepEquals(
        this.lng,
        (other as PhotoMetadataLocation).lng,
      )
    ) {
      return false;
    }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) =>
        bvals.some((w) => PhotoMetadataLocation.__deepEquals(v, w)),
      );
    }
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          PhotoMetadataLocation.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
