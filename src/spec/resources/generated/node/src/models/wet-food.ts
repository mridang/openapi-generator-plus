...
export class WetFood {
  ...
  equals(other: unknown): boolean {
    ...
    if (!(other instanceof WetFood)) {
      return false;
    }
    if (!WetFood.__deepEquals(this.foodType, (other as WetFood).foodType)) {
      return false;
    }
    if (!WetFood.__deepEquals(this.volumeMl, (other as WetFood).volumeMl)) {
      return false;
    }
    return true;
  }
  ...
  private static __deepEquals(a: unknown, b: unknown): boolean {
    ...
    if (Array.isArray(a) && Array.isArray(b)) {
      ...
      return a.every((v, i) => WetFood.__deepEquals(v, b[i]));
    }
    if (a instanceof Set && b instanceof Set) {
      ...
      const bvals = [...b];
      return [...a].every((v) => bvals.some((w) => WetFood.__deepEquals(v, w)));
    }
    if (a instanceof Map && b instanceof Map) {
      ...
      for (const [k, v] of a) {
        if (!b.has(k) || !WetFood.__deepEquals(v, b.get(k))) {
          return false;
        }
      }
      return true;
    ...
    if (typeof a === "object" && typeof b === "object") {
      ...
      return ak.every(
        (k) =>
          ...
          WetFood.__deepEquals(ar[k], br[k]),
      );
    }
    return false;
  }
