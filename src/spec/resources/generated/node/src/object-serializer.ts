  ...
  static serialize(obj: unknown): string {
    ...
    try {
      return JSON.stringify(obj, function (_key, value) {
        ...
        if (this[_key] instanceof Temporal.Duration) return durationToProtoJson(this[_key] as Temporal.Duration);
    ...
    try {
      ...
      if (schemas && json && typeof json === 'object') {
        if (discProp && discMapping && discProp in (json as Record<string, unknown>)) {
           ...
           */
          throw new DeserializationError(`Missing discriminator property '${discProp}' in payload.`);
        }
          ...
          if (schemaCls) {
            try {
              ...
              if (hasValues) {
                 ...
                 */
                new (schemaCls as unknown as new (i: unknown) => unknown)(instance);
                return new (cls as unknown as new (i: unknown) => T)(instance);
              }
            } catch {
              continue;
