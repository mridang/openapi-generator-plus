...
describe('OpenIdConnectAuthenticator', () => {
  ...
  test.skip('throws when discovery is missing authorization_endpoint', async () => {
    // Feature gap: getDelegate() casts discovery.authorization_endpoint to
    // string without a missing-key guard, so an absent endpoint yields
    // `undefined` rather than a thrown discovery error. Skipped so the
  ...
  test.skip('throws when discovery is missing token_endpoint', async () => {
    // Feature gap: getDelegate() casts discovery.token_endpoint to string
    // without a missing-key guard, so an absent endpoint yields `undefined`
    // rather than a thrown discovery error. Skipped so the scenario count
