...
describe('ValueSerializer', () => {
  ...
  describe('query location', () => {
    test('null returns undefined', () => {
      expect(ValueSerializer.serialize(null, 'query', 'string')).toBeUndefined();
    });

    test('undefined returns undefined', () => {
      expect(ValueSerializer.serialize(undefined, 'query', 'string')).toBeUndefined();
    });
    ...
    test('array returns list for multi', () => {
      expect(ValueSerializer.serialize(['a', 'b', 'c'], 'query', 'array', 'multi')).toEqual(['a', 'b', 'c']);
    });
