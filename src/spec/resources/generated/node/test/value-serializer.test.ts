...
describe('ValueSerializer', () => {
  ...
  describe('serializeStyled - form style with explode', () => {
    ...
    test('single-element array with explode true returns list', () => {
      expect(ValueSerializer.serializeStyled('color', ['blue'], 'query', 'array', null, 'form', true)).toEqual(['blue']);
    });
  });
  ...
  describe('serializeStyled - simple style backward compatibility', () => {
    ...
    test('scalar does not URL-encode path value', () => {
      expect(ValueSerializer.serializeStyled('id', 'hello world', 'path', 'string', null, 'simple', false)).toBe('hello world');
    });
  });
