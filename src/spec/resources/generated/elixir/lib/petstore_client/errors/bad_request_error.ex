...
defmodule PetstoreClient.Errors.BadRequestError do
  @moduledoc """
  ...
  def exception(opts) when is_map(opts) do
    %__MODULE__{
      message: Map.get(opts, :message, "Bad Request"),
      code: 400,
  ...
  def exception(msg) when is_binary(msg), do: %__MODULE__{message: msg, code: 400}
