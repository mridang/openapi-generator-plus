...
defmodule PetstoreClient.Errors.InternalServerError do
  @moduledoc """
  ...
  def exception(msg) when is_binary(msg), do: %__MODULE__{message: msg, status_code: 500}
