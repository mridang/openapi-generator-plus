...
defmodule PetstoreClient.Api.PetApi do
  ...
  **Deprecated**: This operation is deprecated.
  ...
  def get_external_pet_info_with_http_info(%__MODULE__{} = api, pet_id, opts \\ []) do
    ...
    path = if String.starts_with?(server_url, "http://") or String.starts_with?(server_url, "https://"), do: server_url <> path, else: path
    query_params = %{}
    header_params = %{}
    request_body = nil
  ...
  **Deprecated**: This operation is deprecated.
  ...
  def upload_pet_document_with_http_info(%__MODULE__{} = api, pet_id, options) do
    ...
    request_body = %{}
    request_body = Map.put(request_body, "file", options.file)
    request_body = if not is_nil(options.document_type), do: Map.put(request_body, "documentType", options.document_type), else: request_body
