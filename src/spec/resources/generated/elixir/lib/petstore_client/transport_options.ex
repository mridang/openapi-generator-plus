...
defmodule PetstoreClient.TransportOptions do
  @moduledoc """
  Immutable HTTP transport configuration for `#{inspect(PetstoreClient.DefaultApiClient)}`.
