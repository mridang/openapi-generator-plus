  ...
  defp parse_oauth2_server_error(status_code, body) do
    ...
    case parsed do
      %{"error" => code} when is_binary(code) and code != "" ->
        description =
          if is_binary(parsed["error_description"]) do
        ...
        uri =
          if is_binary(parsed["error_uri"]) do
            parsed["error_uri"]
          else
            nil
          end
