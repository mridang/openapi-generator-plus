...
defmodule PetstoreClient.DefaultApiClientUnitTest do
  ...
  # Every deadline is armed from the single `:timeout` option: the idle timer,
  # the connect handshake and the pool checkout. Leaving one of them at the
  # library's own default is what made the same expired budget surface under
  # two different types.
