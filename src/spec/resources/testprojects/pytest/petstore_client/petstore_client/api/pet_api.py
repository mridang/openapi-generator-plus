...
class PetApi(BaseApi):
    ...
    def download_pet_document(
        ...
        path = path.replace('{' + 'petId' + '}', quote(ObjectSerializer.to_path_value(pet_id), safe=''))
        path = path.replace('{' + 'documentId' + '}', quote(ObjectSerializer.to_path_value(document_id), safe=''))
        query_params: Dict[str, Any] = {}
        header_params: Dict[str, str] = {}
        body = None
    ...
    def get_pet_photo(
        ...
        path = path.replace('{' + 'petId' + '}', quote(ObjectSerializer.to_path_value(pet_id), safe=''))
        path = path.replace('{' + 'photoId' + '}', quote(ObjectSerializer.to_path_value(photo_id), safe=''))
        query_params: Dict[str, Any] = {}
        header_params: Dict[str, str] = {}
        body = None
