...
class DefaultApiClient:
    ...
    def __init__(self, config=None, pool_manager=None):
    ...
    def send_request(self, method: str, url: str, headers: Dict[str, str], body: Optional[str]) -> ApiResponse:
        ...
        """
        response = self._pool_manager.request(method, url, headers=headers, body=body.encode('utf-8') if body else None)
