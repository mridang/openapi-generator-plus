...
module OpigenClient
  ...
  class HeaderSelector
    ...
    HeaderData = Struct.new(:header, :weight)
    ...
    def get_accept_header_with_adjusted_weight(accept, headers_with_json)
      ...
      unless with_application_json.empty?
        accept_headers.concat(adjust_weight(with_application_json, current_weight, has_more_than_28_headers))
      end
      unless with_json.empty?
        accept_headers.concat(adjust_weight(with_json, current_weight, has_more_than_28_headers))
      end
      unless without_json.empty?
        accept_headers.concat(adjust_weight(without_json, current_weight, has_more_than_28_headers))
      end
