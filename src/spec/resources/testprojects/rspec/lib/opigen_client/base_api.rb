...
module OpigenClient
  class BaseApi
    ...
    def initialize(api_client = DefaultApiClient.new, config = Configuration.default)
    ...
    def invoke_api(method, path, query_params, header_params, body, accepts, content_type, auth_names, return_type)
      ...
      headers['User-Agent'] = "OpenAPI-Generator/#{VERSION}/ruby"
      ...
      if response.status_code < 200 || response.status_code >= 300
        raise ApiError.new(code: response.status_code, response_body: response.body)
      end
