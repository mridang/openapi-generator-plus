...
@javax.annotation.Generated(
    value = "io.github.mridang.codegen.generators.java.BetterJavaCodegen",
    date = "2026-03-05T17:03:16.908879+11:00[Australia/Sydney]",
...
public class Order {
  ...
  @javax.annotation.Nullable private Boolean complete;
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getPetId()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getQuantity()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getShipDate()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      ...
      try {
        joiner.add(
            String.format(
                ...
                prefix,
                suffix,
                URLEncoder.encode(String.valueOf(getComplete()), "UTF-8")
                    .replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
