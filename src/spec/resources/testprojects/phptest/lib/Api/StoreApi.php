...
class StoreApi
{
     ...
     *
     * @param  int $order_id ID of the order to delete (required)
     ...
     *
     * @param  \PetstoreClient\Model\Order|null $order order (optional)
     ...
     * @return \PetstoreClient\Model\Order
     */
    public function placeOrder($order = null, string $contentType = self::contentTypes['placeOrder'][0])
    {
     ...
     * @return array of \PetstoreClient\Model\Order, HTTP status code, HTTP response headers (array of strings)
     */
    public function placeOrderWithHttpInfo($order = null, string $contentType = self::contentTypes['placeOrder'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOrderAsync($order = null, string $contentType = self::contentTypes['placeOrder'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOrderAsyncWithHttpInfo($order = null, string $contentType = self::contentTypes['placeOrder'][0])
    {
        $returnType = '\PetstoreClient\Model\Order';
        $request = $this->placeOrderRequest($order, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function placeOrderRequest($order = null, string $contentType = self::contentTypes['placeOrder'][0])
    {
