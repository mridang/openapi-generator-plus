...
class ObjectSerializer
{
    ...
    public static function setDateTimeFormat(string $format): void
    {
        ...
        self::$serializer = null; // reset to pick up new format
    }
    ...
    private static function getSerializer(): Serializer
    {
        if (self::$serializer === null) {
            ...
            self::$serializer = new Serializer([
                ...
                new DateTimeNormalizer([DateTimeNormalizer::FORMAT_KEY => self::$dateTimeFormat]),
    ...
    public static function sanitizeForSerialization(mixed $data): mixed
    {
        ...
        if ($data instanceof \DateTime) {
            return $data->format(self::$dateTimeFormat);
        }
    ...
    public static function deserialize(mixed $data, string $class, ?array $httpHeaders = null): mixed
    {
        ...
        // Handle array types like 'string[]' or 'Model\Pet[]'
        ...
        // Handle map types like 'array<string,int>'
        ...
        // Handle SplFileObject (file downloads)
        ...
        // For model types, use Symfony deserializer
        if (is_string($data)) {
    ...
    /**
     * Shorten timestamp microseconds to 6 digits length.
     *
    ...
    /**
     * Take value and turn it into a value suitable for form parameters.
     *
     * @param mixed $value the value of the parameter
     *
     ...
     * @param string $style      the format use for serialization
     ...
     * @param int|false $encoding Set to false to not encode, PHP_QUERY_RFC3986 to encode using RFC3986,
     *                            or PHP_QUERY_RFC1738 to encode using RFC1738.
     *
     * @return string
     */
